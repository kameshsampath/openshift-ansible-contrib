...
curl https://raw.githubusercontent.com/kameshsampath/openshift-ansible-contrib/topology/single-master-multi-nodes/reference-architecture/azure-ansible/3.5/add_host.sh -o add_host.sh -s
